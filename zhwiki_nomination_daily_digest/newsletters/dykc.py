...
HEADING_NEW_ENTRY = "\n[[File:Codex icon bellOutline.svg|20px|alt=新增條目|class=skin-invert notpageimage]]&nbsp;'''新增條目：'''共有{num}個新條目提交評選："
HEADING_CHANGES_ENTRY = "\n[[File:Codex icon add.svg|20px|alt=票數變化|class=skin-invert notpageimage]]&nbsp;'''票數變化：'''共有{num}個新條目有票數變化："
HEADING_ENDED_ENTRY = "\n[[File:Codex icon checkAll.svg|20px|alt=完成評選|class=skin-invert notpageimage]]&nbsp;'''完成評選：'''共有{num}個新條目評選已完結："
